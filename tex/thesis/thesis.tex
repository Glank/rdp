...
SPARQL is quite a complex query language. Therefore, generating SPARQL queries can be
...
arechitecture should reduce the need for manually inputting strings. Since SPARQL is
by no means a trivial language, these manually entered strings are also a potential source
