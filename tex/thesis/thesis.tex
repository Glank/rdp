...
And finally, figure \ref{fig:output_example} is an example of the system's operation 
with full output to show each step of the process:
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth,natwidth=1,natheight=1]{imgs/demo/resolve.png}
    \includegraphics[width=1.0\textwidth,natwidth=1,natheight=1]{imgs/demo/resolve_out.png}
